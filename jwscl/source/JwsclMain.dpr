...
\Description                                                        Value
------------------------------------------------------------------  ------------
Last known date the file has changed in the repository              \$Date: 2010-11-28 17:49:23 +0000 (Sun, 28 Nov 2010) $
Last known revision number the file has changed in the repository   \$Revision: 1082 $
Last known author who changed the file in the repository.           \$Author: dezipaitor $
Full URL to the latest version of the file in the repository.       \$HeadURL: file:///svn/p/jedi-apilib/code/jwscl/branches/0.9.4a/source/JwsclMain.dpr $
</table>
}
{$APPTYPE CONSOLE}
Program JwsclMain;
